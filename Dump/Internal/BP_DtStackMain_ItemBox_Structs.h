...
//Function BP_DtStackMain_ItemBox.BP_DtStackMain_ItemBox_C.ExecuteUbergraph_BP_DtStackMain_ItemBox Size 17
class FExecuteUbergraph_BP_DtStackMain_ItemBox
{
 ...
 //Function BP_DtStackMain_ItemBox.BP_DtStackMain_ItemBox_C.PreConstruct Size 1
// Inherited 1 bytes 
class FPreConstruct : public FPreConstruct
{
 ...
 //Function BP_DtStackMain_ItemBox.BP_DtStackMain_ItemBox_C.OnListItemObjectSet Size 8
class FOnListItemObjectSet
{
 ...
 //Function BP_DtStackMain_ItemBox.BP_DtStackMain_ItemBox_C.BP_OnItemSelectionChanged Size 1
class FBP_OnItemSelectionChanged
{
 ...
 //Function BP_DtStackMain_ItemBox.BP_DtStackMain_ItemBox_C.BP_OnItemExpansionChanged Size 1
