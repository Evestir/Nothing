#pragma once 
#include <BP_InfoMainBtn_Achievement_Keyicon_Structs.h>
 
 
 
class UBP_InfoMainBtn_Achievement_Keyicon_C
{
public:
	UBP_InfoMainBtn_Achievement_Keyicon_C(std::uint64_t p_addr = 0) : m_addr(p_addr) {}
	...
	struct UImage Getimg_picto_Achievement() {
