...
class UBP_LobbyMainTabBtn_C
{
public:
	UBP_LobbyMainTabBtn_C(std::uint64_t p_addr = 0) : m_addr(p_addr) {}
	...
	struct UWidgetSwitcher GetWS_BtnNameTxt() {
	...
	struct FText GetI_txt_menu_name() {
		return memory.read<struct FText>(m_addr + 1120);
	}
