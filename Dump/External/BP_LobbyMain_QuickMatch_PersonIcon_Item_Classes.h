#pragma once 
#include <BP_LobbyMain_QuickMatch_PersonIcon_Item_Structs.h>
 
 
 
class UBP_LobbyMain_QuickMatch_PersonIcon_Item_C
{
public:
	UBP_LobbyMain_QuickMatch_PersonIcon_Item_C(std::uint64_t p_addr = 0) : m_addr(p_addr) {}
