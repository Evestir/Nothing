#pragma once 
#include <BP_ModeSelectSubPage_MatchMode_Item_Structs.h>
 
 
 
class UBP_ModeSelectSubPage_MatchMode_Item_C
{
public:
	UBP_ModeSelectSubPage_MatchMode_Item_C(std::uint64_t p_addr = 0) : m_addr(p_addr) {}
	...
	struct UBP_KeyIcon_Bottom_C GetV_ShowItemGuide() {
