...
class UBP_LobbyMain_Challenge_List_Daily_C
{
public:
	UBP_LobbyMain_Challenge_List_Daily_C(std::uint64_t p_addr = 0) : m_addr(p_addr) {}
	...
	struct UBP_LobbyMain_Challenge_ListItem_Daily_C GetV_ChallengeInfo1() {
		auto ptr_addr = memory.read<std::uint64_t>(m_addr + 632);
		return struct UBP_LobbyMain_Challenge_ListItem_Daily_C(ptr_addr);
	}
	struct UBP_LobbyMain_Challenge_ListItem_Daily_C GetV_ChallengeInfo2() {
	...
	struct FMulticastInlineDelegate GetEvent_SendChalDailySetComplete() {
