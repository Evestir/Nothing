#pragma once 
#include <BP_InfoMain_Challenge_ListItem_Premium_Structs.h>
 
 
 
class UBP_InfoMain_Challenge_ListItem_Premium_C
{
public:
	UBP_InfoMain_Challenge_ListItem_Premium_C(std::uint64_t p_addr = 0) : m_addr(p_addr) {}
