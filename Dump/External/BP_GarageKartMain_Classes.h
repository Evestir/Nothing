#pragma once 
#include <BP_GarageKartMain_Structs.h>
 
 
 
class UBP_GarageKartMain_C
{
public:
	UBP_GarageKartMain_C(std::uint64_t p_addr = 0) : m_addr(p_addr) {}
	...
	struct UBP_UpgradeGauge_Garage_C GetV_BP_GarageKartGraph() {
		auto ptr_addr = memory.read<std::uint64_t>(m_addr + 648);
		return struct UBP_UpgradeGauge_Garage_C(ptr_addr);
	}
