#pragma once 
#include <BP_MailMainBtn_PartyFriends_Keyicon_Structs.h>
 
 
 
class UBP_MailMainBtn_PartyFriends_Keyicon_C
{
public:
	UBP_MailMainBtn_PartyFriends_Keyicon_C(std::uint64_t p_addr = 0) : m_addr(p_addr) {}
