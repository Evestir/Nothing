...
};class FExecuteUbergraph_BP_LobbyMain_Challenge_ListItem_Premium
{
public:
	FExecuteUbergraph_BP_LobbyMain_Challenge_ListItem_Premium(std::uint64_t p_addr = 0) : m_addr(p_addr) {}
