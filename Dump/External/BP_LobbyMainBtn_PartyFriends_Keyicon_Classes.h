#pragma once 
#include <BP_LobbyMainBtn_PartyFriends_Keyicon_Structs.h>
 
 
 
class UBP_LobbyMainBtn_PartyFriends_Keyicon_C
{
public:
	UBP_LobbyMainBtn_PartyFriends_Keyicon_C(std::uint64_t p_addr = 0) : m_addr(p_addr) {}
